...
namespace AnyRenderer {
	...
	Image::Format Image::getFormat() const { return d->format; }
	...
	int Image::getWidth() const { return d->w; }

	int Image::getHeight() const { return d->h; }
	...
	unsigned char* Image::data() const { return d->data; }

	bool Image::isNull() const { return d->data == nullptr; }
} // namespace AnyRenderer